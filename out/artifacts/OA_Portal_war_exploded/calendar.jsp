                        ...
                        <section class="vbox">
                            ...
                            <section class="scrollable wrapper">
                                <section class="panel panel-default">
                                    <header class="panel-heading bg-light">Work Calendar</header>
                    ...
                    <aside class="aside-lg b-l">
                        <div class="padder">
                            ...
                            <div id="myEvents" class="pillbox clearfix m-b no-border no-padder">
                                <ul>
                                    <li class="label bg-dark">开会</li>
                                    <li class="label bg-success">工作</li>
                                    <li class="label bg-warning">吃饭</li>
                                    <li class="label bg-danger">学习</li>
                                    <li class="label bg-info">接待客户</li>
                                    <li class="label bg-primary">加班</li>
                                    <input type="text" placeholder="手动添加一个事件">
                                </ul>
                            </div>
                            <div class="line"></div>
                            <div class="checkbox">
                                <label class="checkbox-custom">
                                    ...
                                    <i class="fa fa-square-o"></i> 事件结束后删除</label>
                            </div>
                        </div>
                    </aside>
                    <!-- /.aside --> </section>
